        ...
        {industries.map((industry) => {
          ...
          return (
            <Tabs.Trigger
              key={industry}
              value={industry}
              className="group px-6 py-3 text-sm font-semibold text-neutral-900 border-b-2 border-transparent hover:text-gold hover:border-gold transition-all duration-200 data-[state=active]:text-gold data-[state=active]:border-gold flex items-center gap-2"
            >
              {IconComponent && (
